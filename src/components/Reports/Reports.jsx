  ...
  <div style={{ zIndex: 0, opacity: draggingOver ? '0.1' : '1' }}>
    {files.map((file, index) => (
      ...
      >
        ...
        >
          Referral Type: <b>{selectedStage.title}</b> SRG and <b>{selectedStage.stage}</b> stage<br/> The following information will be required (in pdf format and up to 5MB max size). <br />
